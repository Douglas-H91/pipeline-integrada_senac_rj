...
CREATE DATABASE rede_de_hoteis_nara;

USE rede_de_hoteis_nara;
...
LOAD DATA INFILE "C:/Users/douglas.horvath/pipeline-integrada_senac_rj/unidades_tratada.csv"
INTO TABLE UNIDADES
...
LOAD DATA INFILE "C:/Users/douglas.horvath/pipeline-integrada_senac_rj/quartos_tratada.csv"
INTO TABLE QUARTOS
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 ROWS
...
LOAD DATA INFILE "C:/Users/douglas.horvath/pipeline-integrada_senac_rj/clientes_tratada.csv"
INTO TABLE CLIENTES
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 ROWS
...
LOAD DATA INFILE "C:/Users/douglas.horvath/pipeline-integrada_senac_rj/canais_tratada.csv"
INTO TABLE CANAIS
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 ROWS
...
LOAD DATA INFILE 'C:/Users/douglas.horvath/pipeline-integrada_senac_rj/funcionarios_tratada.csv'
...
LOAD DATA INFILE "C:/Users/douglas.horvath/pipeline-integrada_senac_rj/reservas_tratada.csv"
INTO TABLE RESERVAS
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\n'
IGNORE 1 ROWS
...
-- Total de cancelamentos por unidade
SELECT
    u.nome_unidade,
...
SELECT r.id_cliente, c.nome, r.status_reserva AS status
FROM RESERVAS r
JOIN CLIENTES c ON r.id_cliente = c.id_cliente
WHERE r.status_reserva = 'CANCELADA'
ORDER BY c.nome;

-- cancelamentos por cliente e unidade
SELECT
    c.id_cliente,
    c.nome,
    u.nome_unidade,
...
-- Reservas
SELECT r.id_cliente, c.nome, r.status_reserva, c.cidade_origem
FROM RESERVAS r
JOIN CLIENTES c ON r.id_cliente = c.id_cliente
WHERE c.nome = 'CARLA MENDES'
ORDER BY c.nome;

-- casos com 2 ou mais no-shows por unidade
SELECT c.id_cliente, c.nome, u.nome_unidade, COUNT(r.id_reserva) AS total_no_show
FROM RESERVAS r
JOIN CLIENTES c ON r.id_cliente = c.id_cliente
JOIN UNIDADES u ON r.id_unidade = u.id_unidade
